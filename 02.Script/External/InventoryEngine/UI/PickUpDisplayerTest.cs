...
namespace SurviveCoding.External.InventoryEngine
{
    ...
    /// </summary>
    public class PickUpDisplayerTest : MonoBehaviour, MMEventListener<MMInventoryEvent>
    {
        [Tooltip("the prefab to use to display achievements")]
        public PickUpDisplay PickupDisplayPrefab;
        ...
        private readonly Dictionary<string, PickUpDisplay> _displays = new Dictionary<string, PickUpDisplay>();
